...
def H_ddpg(args=get_args(), task = None, epoch = None, do_term = None, term_reward = None, logdir = None, batch_size = None, hidden_sizes = None, **kwargs):
    ...
    train_envs = SubprocVectorEnv(
        ...
        context = 'fork',share_memory=False
    )
